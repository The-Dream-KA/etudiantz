    ...
    return (
        <footer className="footer">
            <div className="container mx-auto px-4 sm:px-6 py-12 sm:py-16">
                ...
                <div className="flex flex-col sm:flex-row justify-between items-center gap-6 mb-12 pb-8 border-b border-black/20">
                    {/* Brand Name */}
                    <div className="footer-brand">
                        ...
                        />
                        <h2 className="text-4xl font-bold">EtudiantZ.be</h2>
                    </div>
