...
export default function Footer({ locale }: FooterProps) {
    ...
    return (
        <footer className="footer">
            <div className="container mx-auto px-4 sm:px-6 py-6 sm:py-8 w-full">
                {/* Brand and Social Media Icons Row */}
                <div className="flex flex-col sm:flex-row justify-between items-center gap-4 mb-6 pb-4 border-b border-black/20">
                    {/* Brand Name */}
                    <div className="footer-brand">
                        <img
                            src="https://res.cloudinary.com/dpag93lrl/image/upload/v1762317421/Copie_de_dot_Z_1_smfn84.png"
                            alt="EtudiantZ Logo"
                            className="h-8 w-auto mr-3"
                        />
                        <h2 className="text-2xl font-bold">EtudiantZ.be</h2>
                    </div>
                    ...
                    <div className="footer-social">
                        <Link
                            ...
                            className="primary-button-white-blackhover !p-2 !w-10 !h-10 flex items-center justify-center"
                            aria-label="TikTok"
                        >
